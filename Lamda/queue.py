...
def lambda_handler(event, context):
    ...
    # memcache 주소
    memcache_addr = 'client-count-memcache.kmioik.cfg.apn2.cache.amazonaws.com:11211'
...
#     if event['queryStringParameters']['selectLang'] == 'clear':
#         memcache_client = Client('client-count-memcache.kmioik.cfg.apn2.cache.amazonaws.com:11211')
#         memcache_client.set(ktc_today, 0)
